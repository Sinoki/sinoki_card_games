export default class saitama {
  constructor(obj) {
    ...
    this._imgContainer.classList.add('__saitama-img-container');
    ...
    if (obj.el) {
      this.el = obj.el;
      this.el.classList.add('__saitama-container');
    }
  ...
  createImgElement(idx, imgUrl) {
    ...
    el.src = imgUrl;
    el.classList.add('__saitama-img');
  ...
  createElements() {
    ...
    this._moveLeft.classList.add('__saitama-move-left');
    ...
    this._moveRight.classList.add('__saitama-move-right');
