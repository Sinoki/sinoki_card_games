export default class Carousel {
  constructor(obj) {
    ...
    this._imgContainer.classList.add('__carousel-img-container');
    ...
    if (obj.el) {
      this.el = obj.el;
      this.el.classList.add('__carousel-container');
    }
  ...
  createImgElement(idx, imgUrl) {
    ...
    el.src = imgUrl;
    el.classList.add('__carousel-img');
  ...
  createElements() {
    ...
    this._moveLeft.classList.add('__carousel-move-left');
    ...
    this._moveRight.classList.add('__carousel-move-right');
